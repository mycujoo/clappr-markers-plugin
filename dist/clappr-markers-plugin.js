...
/***/ function(module, exports, __webpack_require__) {
	...
	var $marker=marker.$marker;console.log(marker.source._tooltipColour);marker.timeChangedHandler=function(){// fired from marker if it's time changes
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _clappr=__webpack_require__(1);var _marker=__webpack_require__(3);var _marker2=_interopRequireDefault(_marker);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var BaseMarker=function(_Marker){_inherits(BaseMarker,_Marker);function BaseMarker(time,colour){_classCallCheck(this,BaseMarker);var _this=_possibleConstructorReturn(this,(BaseMarker.__proto__||Object.getPrototypeOf(BaseMarker)).call(this));_this._time=time;_this._colour=colour;_this._$marker=_this._buildMarkerEl();_this._$tooltip=null;return _this;}/*
	   ...
	   */},{key:'getTooltipEl',value:function getTooltipEl(){return this._$tooltip;}},{key:'_buildMarkerEl',value:function _buildMarkerEl(){var $marker=(0,_clappr.$)('<div />').addClass('standard-marker');$marker.append((0,_clappr.$)('<div />').addClass('standard-marker-inner').css('background-color',this._colour));return $marker;}/*
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */var StandardMarker=function(_BaseMarker){_inherits(StandardMarker,_BaseMarker);/*
	   ...
	   */function StandardMarker(time,tooltipText){var tooltipColour=arguments.length>2&&arguments[2]!==undefined?arguments[2]:'#FFFFFF';_classCallCheck(this,StandardMarker);var _this=_possibleConstructorReturn(this,(StandardMarker.__proto__||Object.getPrototypeOf(StandardMarker)).call(this,time,tooltipColour));_this._tooltipText=tooltipText||null;_this._tooltipColour=tooltipColour;_this._tooltipText&&_this._setTooltipEl(_this._buildTooltipEl());return _this;}_createClass(StandardMarker,[{key:'_buildTooltipEl',value:function _buildTooltipEl(){return(0,_clappr.$)('<div />').addClass('standard-tooltip').text(this._tooltipText);}}]);return StandardMarker;}(_baseMarker2.default);exports.default=StandardMarker;module.exports=exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/Users/ignacio/Projects/mycujoo/clappr-markers-plugin/node_modules/compass-mixins/lib!./style.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?includePaths[]=/Users/ignacio/Projects/mycujoo/clappr-markers-plugin/node_modules/compass-mixins/lib!./style.sass");
